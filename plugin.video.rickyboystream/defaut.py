...
versao = '1.0.9'
addon_id = 'plugin.video.rickyboystream'
...
def  menus():        		
	...
	dialog.ok("rickyboy STREAM", "          Assistam a vários canais IPTV do Brasil e do mundo !!!")
	addDir('rickyboy STREAM','-',3,'http://todanovidade.com.br/wp-content/gallery/tv-gratis/tv-gratis-13.jpg')
